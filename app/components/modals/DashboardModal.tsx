        ...
        <div className="flex flex-col">
            ...
            <div className="lg:mx-20 mx-5 lg:pt-10 pt-5">
                ...
                <div className="text-neutral-700 mt-3 lg:text-base tracking-tight text-sm">
                    ...
                    Market Intelligence and Business Intelligence divisions in developing dashboards to 
                    visualize and filter potential customer prospects using Power BI and DAX.
                </div>
                <hr className="mt-3"/>
